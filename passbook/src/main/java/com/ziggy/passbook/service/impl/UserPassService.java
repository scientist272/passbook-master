...
public class UserPassService implements IUserPassService {
    ...
    */
    ...
    /**
     * @Description: 通过获取的Passes对象构造Map
     * @Param: [passes]
     * @return: java.util.Map<java.lang.String   ,   com.ziggy.passbook.vo.PassTemplate>
     * @Author: Ziggy
     * @Date: 2019/3/16
     */
    ...
    /**
    * @Description: 通过获取的PassTemplate对象构造Merchants Map
    * @Param: [passTemplates]
    * @return: java.util.Map<java.lang.Integer,com.ziggy.passbook.entity.Merchants>
    * @Author: Ziggy
    * @Date: 2019/3/16
    */
